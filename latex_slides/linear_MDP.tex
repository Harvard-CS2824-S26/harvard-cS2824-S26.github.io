...
\vspace{0.2cm}
\item \textbf{Linear Bellman Completeness:}  $\textrm{poly}(d,H)$
  sample size with gen model.
  \begin{itemize}
  \item What about exploration/episodic setting? \\
    Random exploration is bad with $H>1$.
  \item What about an instantiation?
  \end{itemize}
...
\[
\E_{s'\sim P_h^\star(\cdot\mid s,a)}[f(s')] \;=\; (P_h^\star f)(s,a)
\;=\;
