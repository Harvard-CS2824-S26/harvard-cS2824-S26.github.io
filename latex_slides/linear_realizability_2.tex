...
\begin{frame}{Step 1: The Regression at Stage $h$}
    ...
    \begin{itemize}
        ...
        \item Design Matrix $\Lambda_h = \frac{1}{N}\sum_{i=1}^N \phi(s_i, a_i)
          \phi(s_i, a_i)^\top \approx \frac{1}{N} \Sigma_\rho$.
    \end{itemize}
...
\begin{frame}{Step 2: From Parameters to Pointwise Error}
    ...
    Plug in our bounds:
    \begin{itemize}
        \item Parameter Error: $\approx H \sqrt{\frac{d }{N}}$
        \item Leverage Score (D-Opt): $\sqrt{\phi^\top \Sigma_\rho^{-1} \phi } \le \sqrt{d}$
    \end{itemize}
...
\begin{frame}{Analysis of Offline LSVI}
    ...
    \]
    \[
    \implies \phi^\top \Lambda^{-1} \phi \;\le\; \kappa d
    \]
