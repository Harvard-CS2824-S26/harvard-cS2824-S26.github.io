...
SK: say we had ``the ladder''. this was problematic for $H>1$.
...
SK: maybe show upading the params like in the chapter. I like showing
both decision rules if possible (though maybe one can be ``in the text'').
\begin{enumerate}
...
SK: maybe the below could be simplified? I still want to see the log
factors. but no need to see cosntants. and $2+4$ is irrelevant.
...
\pause
\vspace*{-0.2cm} By the triangle inequality, 
\begin{align*}
