...
\vspace{0.4cm}
\pause
\item \textbf{The Core Goal:} Can we achieve sample complexities that are $\text{poly}(d, H)$?
  \begin{itemize}
    \item \alert{Crucially:} No dependence on the sizes of the state or action spaces ($|S|$ or $|A|$).
  \end{itemize}
