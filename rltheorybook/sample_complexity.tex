...
with some improved rates due to~\cite{pmlr-v125-agarwal20b}.
\fi

[SK can you please fix this based on my comments.]
One of
...
SK: basically, i want to setup the reader with the right high level questions.
1. maybe give a clearer question here, in that the ``answer'' we want
is SA params.
2. say that releative accuracy is eps/(1-gamma)^2. and then ask about
the horizon dependence. above that we have ``horizon amplification''
3. mention the sublinear point
