...
under $r_\infty^{(0)}$,
\[
\PP(r=1)=1/2,\qquad \PP(r=-1)=1/2,
\]
while under $r_\infty^{(1)}$,
\[
\PP(r=1)=(1+m^{-H/2})/2,\qquad \PP(r=-1)=(1-m^{-H/2})/2.
\]
...
connected sample complexity to the VC dimension of a policy class.  The
fundamental tradeoff between polynomial dependence on the size of the state
space and exponential dependence on the horizon is discussed in depth
