...
\[
\|\widehat\theta_h-\theta_h^\star\|_{\widehat\Sigma_h}
\;\le\;
c_1 H \cdot \frac{\sqrt{d}+\sqrt{2\log(1/\delta')}}{\sqrt{n_h}}
\;=\;
c_1 H \cdot \frac{\sqrt{d}+\sqrt{2\log(2H/\delta)}}{\sqrt{n_h}},
\]
...
=
\sqrt{\frac{n_h}{N}}\;\|\widehat\theta_h-\theta_h^\star\|_{\widehat\Sigma_h}
\;\le\;
c_1 H \cdot \frac{\sqrt{d}+\sqrt{2\log(2H/\delta)}}{\sqrt{N}}.
\]
...
\;\le\;
c_1 H \cdot \frac{\sqrt{d}\big(\sqrt{d}+\sqrt{2\log(2H/\delta)}\big)}{\sqrt{N}}.
\]
...
$O(H)$-sub-Gaussian noise. Define the normalized covariance $\Lambda_h:=\frac{1}{N}\sum_{(s,a,r,s')\in D_h}\phi(s,a)\phi(s,a)^\top=\widehat\Sigma_h$.
