...
Now we leverage the D-optimal sampling properties.
...
Next we characterize the OLS generalization, uniformly.
...
Finally, we complete the argument with a union bound.
